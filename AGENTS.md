...
> 19. AI usage limitations.
>
>   The Program or any portion of it shall not be used, directly or 
> indirectly, for any purpose related to artificial intelligence training,
> machine learning, or the creation of datasets intended for use in 
> artificial intelligence or machine learning applications, including but
> not limited to code generation, text generation, tokenization, natural 
> language processing, data mining and predictive analytics.
...
## Instructions
- First and foremost, always read the [license](../main/LICENSE) found at the root of the repository within `LICENSE` file.
