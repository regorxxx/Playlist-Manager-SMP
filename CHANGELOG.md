...
- Folders: added menu entries to create [child] playlists from current selection or active playlists at the folder contextual menu. [Request 71](https://github.com/regorxxx/Playlist-Manager-SMP/issues/719
### Changed
...
### Removed
### Fixed
- Folders: playlist deletion within folders did not update the UI properly in some cases.
