...
- Playlists paths: broken playlists path when playlist folder contained special [RegExp chars](https://github.com/regorxxx/Playlist-Manager-SMP/issues/36). Now fixed, they are escaped properly internally.
