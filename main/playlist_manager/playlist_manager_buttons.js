	...
	if (bSetup) {
		...
		addButton({
			...
			sortButton: new ThemedPanelButton({
				...
				func: function () {
					const test = new FbProfiler(window.FullPanelName + ': ' + 'Sorting - ' + list.getMethodState() + ' - ' + list.getSortState());
