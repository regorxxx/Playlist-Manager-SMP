...
if (!window.ScriptInfo.PackageId) { window.DefineScript('Playlist-Manager-SMP', { author: 'regorxxx', version: '1.0.0-beta.3', features: { drag_n_drop: true, grab_focus: true } }); }
