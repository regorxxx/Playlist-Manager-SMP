...
function addGlobValues(type) {
	...
	switch (type) {
		case 'TF':
			globTags.title = '$ascii($lower($trim($replace(' + _t(globTags.titleRaw) + ',\'\',,`,,’,,´,,-,,\\,,$char(8725),,:,,$char(34),))))'; // Takes ~1 sec on 80K tracks;
			...
			globTags.playCountRateSinceAdded = '$puts(val,$puts(pcr,$div($mul(' + _t(globTags.playCount) + ',100000),$add($mul($sub($year(' + _t(globTags.sortLastPlayed) + '),$year(' + _t(globTags.sortAdded) + ')),365),$mul($sub($month(' + _t(globTags.sortLastPlayed) + '),$month(' + _t(globTags.sortAdded) + ')),30),$sub($day_of_month(' + _t(globTags.sortLastPlayed) + '),$day_of_month(' + _t(globTags.sortAdded) + ')))))$left($ifgreater($mod($get(pcr),100000),0,$ifgreater($get(pcr),100000,,0)$insert($div($get(pcr),10000),\'.\',$sub($len($div($get(pcr),10000)),1))$ifgreater($mod($get(pcr),10000),0,$insert($div($get(pcr),1000),,$sub($len($div($get(pcr),1000)),1)),0),$div($get(pcr),100000)),4))$get(val)$iflonger($get(val),1,,.00)';
			globTags.playCountRateSincePlayed = '$puts(val,$puts(pcr,$div($mul(' + _t(globTags.playCount) + ',100000),$add($mul($sub($year(' + _t(globTags.sortLastPlayed) + '),$year(' + _t(globTags.sortFirstPlayed) + ')),365),$mul($sub($month(' + _t(globTags.sortLastPlayed) + '),$month(' + _t(globTags.sortFirstPlayed) + ')),30),$sub($day_of_month(' + _t(globTags.sortLastPlayed) + '),$day_of_month(' + _t(globTags.sortFirstPlayed) + ')))))$left($ifgreater($mod($get(pcr),100000),0,$ifgreater($get(pcr),100000,,0)$insert($div($get(pcr),10000),\'.\',$sub($len($div($get(pcr),10000)),1))$ifgreater($mod($get(pcr),10000),0,$insert($div($get(pcr),1000),,$sub($len($div($get(pcr),1000)),1)),0),$div($get(pcr),100000)),4)$get(val)$iflonger($get(val),1,,.00)';
			globTags.playCountRateGlobalDay = '$puts(val,$puts(pcr,$div($mul(' + _t(globTags.playCount) + ',100000),$add($mul($sub(#YEAR#,$year(' + _t(globTags.sortAdded) + ')),365),$mul($sub(#MONTH#,$month(' + _t(globTags.sortAdded) + ')),30),$sub(#DAY#,$day_of_month(' + _t(globTags.sortAdded) + ')))))$left($ifgreater($mod($get(pcr),100000),0,$ifgreater($get(pcr),100000,,0)$insert($div($get(pcr),10000),\'.\',$sub($len($div($get(pcr),10000)),1))$ifgreater($mod($get(pcr),10000),0,$insert($div($get(pcr),1000),,$sub($len($div($get(pcr),1000)),1)),0),$div($get(pcr),100000)),4))$get(val)$iflonger($get(val),1,,.00)';
			globTags.playCountRateGlobalWeek = '$puts(val,$puts(pcr,$div($mul(' + _t(globTags.playCount) + ',100000),$add($mul($sub(#YEAR#,$year(' + _t(globTags.sortAdded) + ')),52),$mul($sub(#MONTH#,$month(' + _t(globTags.sortAdded) + ')),4),$div($sub(#DAY#,$day_of_month(' + _t(globTags.sortAdded) + ')),7))))$left($ifgreater($mod($get(pcr),100000),0,$ifgreater($get(pcr),100000,,0)$insert($div($get(pcr),10000),\'.\',$sub($len($div($get(pcr),10000)),1))$ifgreater($mod($get(pcr),10000),0,$insert($div($get(pcr),1000),,$sub($len($div($get(pcr),1000)),1)),0),$div($get(pcr),100000)),4))$get(val)$iflonger($get(val),1,,.00)';
			globTags.playCountRateGlobalMonth = '$puts(val,$puts(pcr,$div($mul(' + _t(globTags.playCount) + ',100000),$add($mul($sub(#YEAR#,$year(' + _t(globTags.sortAdded) + ')),12),$sub(#MONTH#,$month(' + _t(globTags.sortAdded) + ')))))$left($ifgreater($mod($get(pcr),100000),0,$ifgreater($get(pcr),100000,,0)$insert($div($get(pcr),10000),\'.\',$sub($len($div($get(pcr),10000)),1))$ifgreater($mod($get(pcr),10000),0,$insert($div($get(pcr),1000),,$sub($len($div($get(pcr),1000)),1)),0),$div($get(pcr),100000)),4))$puts(dec,$muldiv($sub(#DAY#,$day_of_month(' + _t(globTags.sortAdded) + ')),100,30))$puts(dec,$ifgreater($get(dec),0,$get(dec),00))$puts(val,$get(val)$iflonger($get(val),1,,.$get(dec)))$get(val)$iflonger($get(val),3,,0)';
			globTags.playCountRateGlobalYear = '$puts(val,$puts(pcr,$div($mul(' + _t(globTags.playCount) + ',100000),$sub(#YEAR#,$year(' + _t(globTags.sortAdded) + '))))$left($ifgreater($mod($get(pcr),100000),0,$ifgreater($get(pcr),100000,,0)$insert($div($get(pcr),10000),\'.\',$sub($len($div($get(pcr),10000)),1))$ifgreater($mod($get(pcr),10000),0,$insert($div($get(pcr),1000),,$sub($len($div($get(pcr),1000)),1)),0),$div($get(pcr),100000)),4))$puts(dec,$muldiv($sub(#MONTH#,$month(' + _t(globTags.sortAdded) + ')),100,12))$puts(dec,$ifgreater($get(dec),0,$get(dec),00))$puts(val,$get(val)$iflonger($get(val),1,,.$get(dec)))$get(val)$iflonger($get(val),3,,0)';
			globTags.playCountExpectedSinceAdded = '$div($mul($div($mul(' + _t(globTags.playCount) + ',100000),$add($mul($sub($year(' + _t(globTags.sortLastPlayed) + '),$year(' + _t(globTags.sortAdded) + ')),365),$mul($sub($month(' + _t(globTags.sortLastPlayed) + '),$month(' + _t(globTags.sortAdded) + ')),30),$sub($day_of_month(' + _t(globTags.sortLastPlayed) + '),$day_of_month(' + _t(globTags.sortAdded) + ')))),$add($mul($sub(#YEAR#,$year(' + _t(globTags.sortAdded) + ')),365),$mul($sub(#MONTH#,$month(' + _t(globTags.sortFirstPlayed) + ')),30),$sub(#DAY#,$day_of_month(' + _t(globTags.sortAdded) + ')))),100000)';
			globTags.playCountExpectedSincePlayed = '$div($mul($div($mul(' + _t(globTags.playCount) + ',100000),$add($mul($sub($year(' + _t(globTags.sortLastPlayed) + '),$year(' + _t(globTags.sortFirstPlayed) + ')),365),$mul($sub($month(' + _t(globTags.sortLastPlayed) + '),$month(' + _t(globTags.sortFirstPlayed) + ')),30),$sub($day_of_month(' + _t(globTags.sortLastPlayed) + '),$day_of_month(' + _t(globTags.sortFirstPlayed) + ')))),$add($mul($sub(#YEAR#,$year(' + _t(globTags.sortFirstPlayed) + ')),365),$mul($sub(#MONTH#,$month(' + _t(globTags.sortFirstPlayed) + ')),30),$sub(#DAY#,$day_of_month(' + _t(globTags.sortFirstPlayed) + ')))),100000)';
			globTags.trackTitlePath = '$puts(path,[$replace(%TITLE%,$char(92),-,$char(47),-)])$puts(path,$replace($get(path),:,, ?$char(92),,$char(63),,$char(191),,$char(8725),-,$char(36),,$char(37),,$char(35) ,,$char(35),$char(42),,$char(33),,$char(161),,$char(124),-,$char(34),$char(39)$char(39),<,,>,,^,,... ,,...,,.,))$puts(path,$replace($get(path),á,a,é,e,í,i,ó,o,ú,u,Á,A,É,E,Í,I,Ó,O,Ú,U,ü,u,Ü,U,ñ,n,Ñ,N,è,e,ê,e,Ê,E,ì,i,î,i,ï,i,à,a,â,a,ò,o,ô,o,ù,u,û,u,ç,c,Ç,C,ß,ss,œ,oe,Œ,OE))$puts(path,$replace($get(path),А,A,Б,B,В,V,Г,G,Д,D,Е,E,Ё,Jo,Ж,Zh,З,Z,И,I,Й,J,К,K,Л,L,М,M,Н,N,О,O,П,P,Р,R,С,S,Т,T,У,U,Ф,F,Х,H,Ц,C,Ч,Ch,Ш,Sh,Щ,Sht,Ъ,Y,Ь,J,Э,E,Ю,Ju,Я,Ja,а,a,б,b,в,v,г,g,д,d,е,e,ё,jo,ж,zh,з,z,и,i,й,j,к,k,л,l,м,m,н,n,о,o,п,p,р,r,с,s,т,t,у,u,ф,f,х,h,ц,c,ч,ch,ш,sh,щ,sht,ъ,y,ь,j,э,e,ю,ju,я,ja,ы,y))$puts(path,$trim($replace($ascii($get(path)),$char(63),,$char(92)$char(92),$char(92)_$char(92),  $char(92),$char(92), $char(92),$char(92))))$iflonger($get(path),1,$get(path),$crc32(%TITLE%))';
			globTags.artistAlbumTrackTitlePath = '$puts(path,$replace($if($meta_test(ALBUM ARTIST),$meta(ALBUM ARTIST,0),$meta(ARTIST,0)),$char(92),-,$char(47),-)$char(92)[$replace($meta(ALBUM,0),$char(92),-,$char(47),-)]$char(92)[%TRACK% - ][$replace(%TITLE%,$char(92),-,$char(47),-)],$char(124),_))$puts(path,$replace($get(path),:,, ?$char(92),,$char(63),,$char(191),,$char(8725),-,$char(36),,$char(37),,$char(35) ,,$char(35),,$char(42),,$char(33),,$char(161),,$char(34),$char(39)$char(39),<,,>,,^,,... ,,...,,.,))$puts(path,$replace($replace($get(path),á,a,é,e,í,i,ó,o,ú,u,Á,A,É,E,Í,I,Ó,O,Ú,U,ü,u,Ü,U,ñ,n,Ñ,N,è,e,ê,e,Ê,E,ì,i,î,i,ï,i,à,a,â,a,ò,o,ô,o,ù,u,û,u,ç,c,Ç,C,ß,ss,œ,oe,Œ,OE))$puts(path,$replace($get(path),А,A,Б,B,В,V,Г,G,Д,D,Е,E,Ё,Jo,Ж,Zh,З,Z,И,I,Й,J,К,K,Л,L,М,M,Н,N,О,O,П,P,Р,R,С,S,Т,T,У,U,Ф,F,Х,H,Ц,C,Ч,Ch,Ш,Sh,Щ,Sht,Ъ,Y,Ь,J,Э,E,Ю,Ju,Я,Ja,а,a,б,b,в,v,г,g,д,d,е,e,ё,jo,ж,zh,з,z,и,i,й,j,к,k,л,l,м,m,н,n,о,o,п,p,р,r,с,s,т,t,у,u,ф,f,х,h,ц,c,ч,ch,ш,sh,щ,sht,ъ,y,ь,j,э,e,ю,ju,я,ja,ы,y))$puts(path,$replace($trim($replace($ascii($get(path)),$char(63),,$char(92)$char(92),$char(92)_$char(92))),$char(92) $char(92),$char(92)_$char(92),  $char(92),$char(92), $char(92),$char(92)))$ifequal($strchr($get(path),$char(92)),1,$puts(path,_$get(path)),)$ifequal($strrchr($get(path),$char(92)),$len($get(path)),$puts(path,$get(path)$crc32(%TITLE%)),)$get(path)';
			globTags.initialArtistAlbumTrackTitlePath = '$puts(initial,$upper($cut($replace($swapprefix($if($meta_test(ALBUM ARTIST),$meta(ALBUM ARTIST,0),$meta(ARTIST,0)),A,An,The,Las,Los,Les,La,El,Le,Lo,Au,Aux,Il,I,L\'\',Gli,Una,Uno,Une,Unas,Unos,Unes,Der,Das,Die,Al,Ar,Ul,Ur,Els,Uns,Des,O,Os,As,Um,Uma,Uns,Umas),$char(33),,$char(34),,$char(35),,$char(36),,$char(37),,$char(38),,$char(39)$char(39),,$char(39),,,$char(40),,$char(41),,$char(42),,$char(43),,$char(44),,$char(45),,$char(46),,$char(47),),1)))$puts(path,$replace($replace($if($meta_test(ALBUM ARTIST),$meta(ALBUM ARTIST,0),$meta(ARTIST,0)),$char(92),-,$char(47),-)$char(92)[$replace($meta(ALBUM,0),$char(92),-,$char(47),-)]$char(92)[%TRACK% - ][$replace(%TITLE%,$char(92),-,$char(47),-)],$char(124),_))$puts(path,$replace($get(path),:,, ?$char(92),,$char(63),,$char(191),,$char(8725),-,$char(36),,$char(37),,$char(35) ,,$char(35),,$char(42),,$char(33),,$char(161),,$char(34),$char(39)$char(39),<,,>,,^,,... ,,...,,.,,$char(38),and))$puts(path,$replace($get(path),á,a,é,e,í,i,ó,o,ú,u,Á,A,É,E,Í,I,Ó,O,Ú,U,ü,u,Ü,U,ñ,n,Ñ,N,è,e,ê,e,Ê,E,ì,i,î,i,ï,i,à,a,â,a,ò,o,ô,o,ù,u,û,u,ç,c,Ç,C,ß,ss,œ,oe,Œ,OE))$puts(path,$replace($get(path),А,A,Б,B,В,V,Г,G,Д,D,Е,E,Ё,Jo,Ж,Zh,З,Z,И,I,Й,J,К,K,Л,L,М,M,Н,N,О,O,П,P,Р,R,С,S,Т,T,У,U,Ф,F,Х,H,Ц,C,Ч,Ch,Ш,Sh,Щ,Sht,Ъ,Y,Ь,J,Э,E,Ю,Ju,Я,Ja,а,a,б,b,в,v,г,g,д,d,е,e,ё,jo,ж,zh,з,z,и,i,й,j,к,k,л,l,м,m,н,n,о,o,п,p,р,r,с,s,т,t,у,u,ф,f,х,h,ц,c,ч,ch,ш,sh,щ,sht,ъ,y,ь,j,э,e,ю,ju,я,ja,ы,y))$puts(path,$replace($trim($replace($ascii($get(path)),$char(63),,$char(92)$char(92),$char(92)_$char(92))),$char(92) $char(92),$char(92)_$char(92),$char(92)$char(92),$char(92)_$char(92),  $char(92),$char(92), $char(92),$char(92)))$ifequal($strchr($get(path),$char(92)),1,$puts(path,_$get(path)),)$ifequal($strrchr($get(path),$char(92)),$len($get(path)),$puts(path,$get(path)$crc32(%TITLE%)),)$if($stricmp($ascii($get(initial)),?),$get(initial),$ascii($get(initial)))$char(92)$get(path)';
			globTags.artistAlbumTrackIdPath = '$puts(path,$replace($replace($if($meta_test(ALBUM ARTIST),$meta(ALBUM ARTIST,0),$meta(ARTIST,0)),$char(92),-,$char(47),-)$char(92)[$abbr($replace($meta(ALBUM,0){$if2($replace(%COMMENT%,$char(92),,$char(8725),),%MUSICBRAINZ_ALBUMID%) },$char(92),-,$char(47),-))]$char(92)[%TRACK% - ][$abbr($replace(%TITLE%,$char(92),-,$char(47),-))],$char(124),_))$puts(path,$replace($get(path),:,, ?$char(92),,$char(63),,$char(191),,$char(8725),-,$char(36),,$char(37),,$char(35) ,,$char(35),,$char(42),,$char(33),,$char(161),,$char(34),$char(39)$char(39),<,,>,,^,,... ,,...,,.,))$puts(path,$replace($get(path),á,a,é,e,í,i,ó,o,ú,u,Á,A,É,E,Í,I,Ó,O,Ú,U,ü,u,Ü,U,ñ,n,Ñ,N,è,e,ê,e,Ê,E,ì,i,î,i,ï,i,à,a,â,a,ò,o,ô,o,ù,u,û,u,ç,c,Ç,C,ß,ss,œ,oe,Œ,OE))$puts(path,$replace($get(path),А,A,Б,B,В,V,Г,G,Д,D,Е,E,Ё,Jo,Ж,Zh,З,Z,И,I,Й,J,К,K,Л,L,М,M,Н,N,О,O,П,P,Р,R,С,S,Т,T,У,U,Ф,F,Х,H,Ц,C,Ч,Ch,Ш,Sh,Щ,Sht,Ъ,Y,Ь,J,Э,E,Ю,Ju,Я,Ja,а,a,б,b,в,v,г,g,д,d,е,e,ё,jo,ж,zh,з,z,и,i,й,j,к,k,л,l,м,m,н,n,о,o,п,p,р,r,с,s,т,t,у,u,ф,f,х,h,ц,c,ч,ch,ш,sh,щ,sht,ъ,y,ь,j,э,e,ю,ju,я,ja,ы,y))$puts(path,$lower($replace($trim($replace($ascii($get(path)),$char(63),,$char(92)$char(92),$char(92)_$char(92))),$char(92) $char(92),$char(92)_$char(92),  $char(92),$char(92), $char(92),$char(92))))$ifequal($strchr($get(path),$char(92)),1,$puts(path,_$get(path)),)$ifequal($strrchr($get(path),$char(92)),$len($get(path)),$puts(path,$get(path)$crc32(%TITLE%)),)$get(path)';
			globTags.artistInitial = '$puts(initial,$upper($cut($replace($swapprefix($if($meta_test(ALBUM ARTIST),$meta(ALBUM ARTIST,0),$meta(ARTIST,0)),A,An,The,Las,Los,Les,La,El,Le,Lo,Au,Aux,Il,I,L\'\',Gli,Una,Uno,Une,Unas,Unos,Unes,Der,Das,Die,Al,Ar,Ul,Ur,Els,Uns,Des,O,Os,As,Um,Uma,Uns,Umas),$char(33),,$char(34),,$char(35),,$char(36),,$char(37),,$char(38),,$char(39)$char(39),,$char(39),,,$char(40),,$char(41),,$char(42),,$char(43),,$char(44),,$char(45),,$char(46),,$char(47),),1)))$puts(initial,$replace($get(initial),á,a,é,e,í,i,ó,o,ú,u,Á,A,É,E,Í,I,Ó,O,Ú,U,ü,u,Ü,U,ñ,n,Ñ,N,è,e,ê,e,Ê,E,ì,i,î,i,ï,i,à,a,â,a,ò,o,ô,o,ù,u,û,u,ç,c,Ç,C,ß,ss,œ,oe,Œ,OE))$puts(initial,$replace($get(initial),А,A,Б,B,В,V,Г,G,Д,D,Е,E,Ё,Jo,Ж,Zh,З,Z,И,I,Й,J,К,K,Л,L,М,M,Н,N,О,O,П,P,Р,R,С,S,Т,T,У,U,Ф,F,Х,H,Ц,C,Ч,Ch,Ш,Sh,Щ,Sht,Ъ,Y,Ь,J,Э,E,Ю,Ju,Я,Ja,а,a,б,b,в,v,г,g,д,d,е,e,ё,jo,ж,zh,з,z,и,i,й,j,к,k,л,l,м,m,н,n,о,o,п,p,р,r,с,s,т,t,у,u,ф,f,х,h,ц,c,ч,ch,ш,sh,щ,sht,ъ,y,ь,j,э,e,ю,ju,я,ja,ы,y))$if($stricmp($ascii($get(initial)),?),$get(initial),$ascii($get(initial)))';
			globTags.camelotKey = '$if($stricmp(' + _t(globTags.key) + ',G#m),$puts(kTrans,1A))$if($stricmp(' + _t(globTags.key) + ',Abm),$puts(kTrans,1A))$if($stricmp(' + _t(globTags.key) + ',D#m),$puts(kTrans,2A))$if($stricmp(' + _t(globTags.key) + ',Ebm),$puts(kTrans,2A))$if($stricmp(' + _t(globTags.key) + ',A#m),$puts(kTrans,3A))$if($stricmp(' + _t(globTags.key) + ',Bbm),$puts(kTrans,3A))$if($stricmp(' + _t(globTags.key) + ',Fm),$puts(kTrans,4A))$if($stricmp(' + _t(globTags.key) + ',Cm),$puts(kTrans,5A))$if($stricmp(' + _t(globTags.key) + ',Gm),$puts(kTrans,6A))$if($stricmp(' + _t(globTags.key) + ',Dm),$puts(kTrans,7A))$if($stricmp(' + _t(globTags.key) + ',Am),$puts(kTrans,8A))$if($stricmp(' + _t(globTags.key) + ',Em),$puts(kTrans,9A))$if($stricmp(' + _t(globTags.key) + ',Bm),$puts(kTrans,10A))$if($stricmp(' + _t(globTags.key) + ',F#m),$puts(kTrans,11A))$if($stricmp(' + _t(globTags.key) + ',Gbm),$puts(kTrans,11A))$if($stricmp(' + _t(globTags.key) + ',C#m),$puts(kTrans,12A))$if($stricmp(' + _t(globTags.key) + ',Dbm),$puts(kTrans,12A))$if($stricmp(' + _t(globTags.key) + ',6m),$puts(kTrans,1A))$if($stricmp(' + _t(globTags.key) + ',7m),$puts(kTrans,2A))$if($stricmp(' + _t(globTags.key) + ',8m),$puts(kTrans,3A))$if($stricmp(' + _t(globTags.key) + ',9m),$puts(kTrans,4A))$if($stricmp(' + _t(globTags.key) + ',10m),$puts(kTrans,5A))$if($stricmp(' + _t(globTags.key) + ',11m),$puts(kTrans,6A))$if($stricmp(' + _t(globTags.key) + ',12m),$puts(kTrans,7A))$if($stricmp(' + _t(globTags.key) + ',1m),$puts(kTrans,8A))$if($stricmp(' + _t(globTags.key) + ',2m),$puts(kTrans,9A))$if($stricmp(' + _t(globTags.key) + ',3m),$puts(kTrans,10A))$if($stricmp(' + _t(globTags.key) + ',4m),$puts(kTrans,11A))$if($stricmp(' + _t(globTags.key) + ',5m),$puts(kTrans,12A))$if($stricmp(' + _t(globTags.key) + ',B),$puts(kTrans,1B))$if($stricmp(' + _t(globTags.key) + ',F#),$puts(kTrans,2B))$if($stricmp(' + _t(globTags.key) + ',Gb),$puts(kTrans,2B))$if($stricmp(' + _t(globTags.key) + ',C#),$puts(kTrans,3B))$if($stricmp(' + _t(globTags.key) + ',Db),$puts(kTrans,3B))$if($stricmp(' + _t(globTags.key) + ',G#),$puts(kTrans,4B))$if($stricmp(' + _t(globTags.key) + ',Ab),$puts(kTrans,4B))$if($stricmp(' + _t(globTags.key) + ',D#),$puts(kTrans,5B))$if($stricmp(' + _t(globTags.key) + ',Eb),$puts(kTrans,5B))$if($stricmp(' + _t(globTags.key) + ',A#),$puts(kTrans,6B))$if($stricmp(' + _t(globTags.key) + ',Bb),$puts(kTrans,6B))$if($stricmp(' + _t(globTags.key) + ',F),$puts(kTrans,7B))$if($stricmp(' + _t(globTags.key) + ',C),$puts(kTrans,8B))$if($stricmp(' + _t(globTags.key) + ',G),$puts(kTrans,9B))$if($stricmp(' + _t(globTags.key) + ',D),$puts(kTrans,10B))$if($stricmp(' + _t(globTags.key) + ',A),$puts(kTrans,11B))$if($stricmp(' + _t(globTags.key) + ',E),$puts(kTrans,12B))$if($stricmp(' + _t(globTags.key) + ',6d),$puts(kTrans,1B))$if($stricmp(' + _t(globTags.key) + ',7d),$puts(kTrans,2B))$if($stricmp(' + _t(globTags.key) + ',8d),$puts(kTrans,3B))$if($stricmp(' + _t(globTags.key) + ',9d),$puts(kTrans,4B))$if($stricmp(' + _t(globTags.key) + ',10d),$puts(kTrans,5B))$if($stricmp(' + _t(globTags.key) + ',11d),$puts(kTrans,6B))$if($stricmp(' + _t(globTags.key) + ',12d),$puts(kTrans,7B))$if($stricmp(' + _t(globTags.key) + ',1d),$puts(kTrans,8B))$if($stricmp(' + _t(globTags.key) + ',2d),$puts(kTrans,9B))$if($stricmp(' + _t(globTags.key) + ',3d),$puts(kTrans,10B))$if($stricmp(' + _t(globTags.key) + ',4d),$puts(kTrans,11B))$if($stricmp(' + _t(globTags.key) + ',5d),$puts(kTrans,12B))$if($get(kTrans),,$puts(kTrans,[' + _t(globTags.key) + ']))$get(kTrans)';
			globTags.openKey = '$if($stricmp(' + _t(globTags.key) + ',G#m),$puts(kTrans,1A))$if($stricmp(' + _t(globTags.key) + ',Abm),$puts(kTrans,1A))$if($stricmp(' + _t(globTags.key) + ',D#m),$puts(kTrans,2A))$if($stricmp(' + _t(globTags.key) + ',Ebm),$puts(kTrans,2A))$if($stricmp(' + _t(globTags.key) + ',A#m),$puts(kTrans,3A))$if($stricmp(' + _t(globTags.key) + ',Bbm),$puts(kTrans,3A))$if($stricmp(' + _t(globTags.key) + ',Fm),$puts(kTrans,4A))$if($stricmp(' + _t(globTags.key) + ',Cm),$puts(kTrans,5A))$if($stricmp(' + _t(globTags.key) + ',Gm),$puts(kTrans,6A))$if($stricmp(' + _t(globTags.key) + ',Dm),$puts(kTrans,7A))$if($stricmp(' + _t(globTags.key) + ',Am),$puts(kTrans,8A))$if($stricmp(' + _t(globTags.key) + ',Em),$puts(kTrans,9A))$if($stricmp(' + _t(globTags.key) + ',Bm),$puts(kTrans,10A))$if($stricmp(' + _t(globTags.key) + ',F#m),$puts(kTrans,11A))$if($stricmp(' + _t(globTags.key) + ',Gbm),$puts(kTrans,11A))$if($stricmp(' + _t(globTags.key) + ',C#m),$puts(kTrans,12A))$if($stricmp(' + _t(globTags.key) + ',Dbm),$puts(kTrans,12A))$if($stricmp(' + _t(globTags.key) + ',B),$puts(kTrans,1B))$if($stricmp(' + _t(globTags.key) + ',F#),$puts(kTrans,2B))$if($stricmp(' + _t(globTags.key) + ',Gb),$puts(kTrans,2B))$if($stricmp(' + _t(globTags.key) + ',C#),$puts(kTrans,3B))$if($stricmp(' + _t(globTags.key) + ',Db),$puts(kTrans,3B))$if($stricmp(' + _t(globTags.key) + ',G#),$puts(kTrans,4B))$if($stricmp(' + _t(globTags.key) + ',Ab),$puts(kTrans,4B))$if($stricmp(' + _t(globTags.key) + ',D#),$puts(kTrans,5B))$if($stricmp(' + _t(globTags.key) + ',Eb),$puts(kTrans,5B))$if($stricmp(' + _t(globTags.key) + ',A#),$puts(kTrans,6B))$if($stricmp(' + _t(globTags.key) + ',Bb),$puts(kTrans,6B))$if($stricmp(' + _t(globTags.key) + ',F),$puts(kTrans,7B))$if($stricmp(' + _t(globTags.key) + ',C),$puts(kTrans,8B))$if($stricmp(' + _t(globTags.key) + ',G),$puts(kTrans,9B))$if($stricmp(' + _t(globTags.key) + ',D),$puts(kTrans,10B))$if($stricmp(' + _t(globTags.key) + ',A),$puts(kTrans,11B))$if($stricmp(' + _t(globTags.key) + ',E),$puts(kTrans,12B))$if($get(kTrans),,$puts(kTrans,[' + _t(globTags.key) + ']))$if($stricmp($get(kTrans),1A),$puts(kTrans,6m))$if($stricmp($get(kTrans),2A),$puts(kTrans,7m))$if($stricmp($get(kTrans),3A),$puts(kTrans,8m))$if($stricmp($get(kTrans),4A),$puts(kTrans,9m))$if($stricmp($get(kTrans),5A),$puts(kTrans,10m))$if($stricmp($get(kTrans),6A),$puts(kTrans,11m))$if($stricmp($get(kTrans),7A),$puts(kTrans,12m))$if($stricmp($get(kTrans),8A),$puts(kTrans,1m))$if($stricmp($get(kTrans),9A),$puts(kTrans,2m))$if($stricmp($get(kTrans),10A),$puts(kTrans,3m))$if($stricmp($get(kTrans),11A),$puts(kTrans,4m))$if($stricmp($get(kTrans),12A),$puts(kTrans,5m))$if($stricmp($get(kTrans),1B),$puts(kTrans,6d))$if($stricmp($get(kTrans),2B),$puts(kTrans,7d))$if($stricmp($get(kTrans),3B),$puts(kTrans,8d))$if($stricmp($get(kTrans),4B),$puts(kTrans,9d))$if($stricmp($get(kTrans),5B),$puts(kTrans,10d))$if($stricmp($get(kTrans),6B),$puts(kTrans,11d))$if($stricmp($get(kTrans),7B),$puts(kTrans,12d))$if($stricmp($get(kTrans),8B),$puts(kTrans,1d))$if($stricmp($get(kTrans),9B),$puts(kTrans,2d))$if($stricmp($get(kTrans),10B),$puts(kTrans,3d))$if($stricmp($get(kTrans),11B),$puts(kTrans,4d))$if($stricmp($get(kTrans),12B),$puts(kTrans,5d))$get(kTrans)';
			break;
		case 'Query':
...
const globTags = {
	...
	sbdSimilarArtist: 'SIMILAR ARTISTS MUSICMAP',
	lfmSimilarArtist: 'SIMILAR ARTISTS LAST.FM'
};
...
const globSettings = {
	...
	_description: 'Settings used by scripts at multiple places. File is loaded on the fly at startup, so no hard-saving on properties is involved (thus only requiring a panel reload to use the new values)',
