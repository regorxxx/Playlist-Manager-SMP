...
function addGlobValues(type) {
	...
	switch (type) {
		case 'TF':
			...
			globTags.trackTitlePath = '$puts(path,[$replace(%TITLE%,$char(92),-,$char(47),-)])$puts(path,$replace($get(path),:,, ?$char(92),,$char(63),,$char(191),,$char(8725),-,$char(36),,$char(37),,$char(35) ,,$char(35),$char(42),,$char(33),,$char(161),,$char(124),-,$char(34),$char(39)$char(39),<,,>,,^,,... ,,...,,.,))$puts(path,$replace($get(path),á,a,é,e,í,i,ó,o,ú,u,Á,A,É,E,Í,I,Ó,O,Ú,U,ü,u,Ü,U,ñ,n,Ñ,N,è,e,ê,e,Ê,E,ì,i,î,i,ï,i,à,a,â,a,ò,o,ô,o,ù,u,û,u,ç,c,Ç,C,ß,ss,œ,oe,Œ,OE))$puts(path,$replace($get(path),А,A,Б,B,В,V,Г,G,Д,D,Е,E,Ё,Jo,Ж,Zh,З,Z,И,I,Й,J,К,K,Л,L,М,M,Н,N,О,O,П,P,Р,R,С,S,Т,T,У,U,Ф,F,Х,H,Ц,C,Ч,Ch,Ш,Sh,Щ,Sht,Ъ,Y,Ь,J,Э,E,Ю,Ju,Я,Ja,а,a,б,b,в,v,г,g,д,d,е,e,ё,jo,ж,zh,з,z,и,i,й,j,к,k,л,l,м,m,н,n,о,o,п,p,р,r,с,s,т,t,у,u,ф,f,х,h,ц,c,ч,ch,ш,sh,щ,sht,ъ,y,ь,j,э,e,ю,ju,я,ja,ы,y))$puts(path,$trim($replace($ascii($get(path)),$char(63),,$char(92)$char(92),$char(92)_$char(92))))$iflonger($get(path),1,$get(path),$crc32(%TITLE%))';
			globTags.artistAlbumTrackTitlePath = '$puts(path,$replace($if($meta_test(ALBUM ARTIST),$meta(ALBUM ARTIST,0),$meta(ARTIST,0)),$char(92),-,$char(47),-)$char(92)[$replace(%ALBUM%,$char(92),-,$char(47),-)]$char(92)[%TRACK% - ][$replace(%TITLE%,$char(92),-,$char(47),-)])$puts(path,$replace($get(path),:,, ?$char(92),,$char(63),,$char(191),,$char(8725),-,$char(36),,$char(37),,$char(35) ,,$char(35),,$char(42),,$char(33),,$char(161),,$char(124),-,$char(34),$char(39)$char(39),<,,>,,^,,... ,,...,,.,))$puts(path,$replace($get(path),á,a,é,e,í,i,ó,o,ú,u,Á,A,É,E,Í,I,Ó,O,Ú,U,ü,u,Ü,U,ñ,n,Ñ,N,è,e,ê,e,Ê,E,ì,i,î,i,ï,i,à,a,â,a,ò,o,ô,o,ù,u,û,u,ç,c,Ç,C,ß,ss,œ,oe,Œ,OE))$puts(path,$replace($get(path),А,A,Б,B,В,V,Г,G,Д,D,Е,E,Ё,Jo,Ж,Zh,З,Z,И,I,Й,J,К,K,Л,L,М,M,Н,N,О,O,П,P,Р,R,С,S,Т,T,У,U,Ф,F,Х,H,Ц,C,Ч,Ch,Ш,Sh,Щ,Sht,Ъ,Y,Ь,J,Э,E,Ю,Ju,Я,Ja,а,a,б,b,в,v,г,g,д,d,е,e,ё,jo,ж,zh,з,z,и,i,й,j,к,k,л,l,м,m,н,n,о,o,п,p,р,r,с,s,т,t,у,u,ф,f,х,h,ц,c,ч,ch,ш,sh,щ,sht,ъ,y,ь,j,э,e,ю,ju,я,ja,ы,y))$puts(path,$replace($trim($replace($ascii($get(path)),$char(63),,$char(92)$char(92),$char(92)_$char(92))),$char(92) $char(92),$char(92)_$char(92)))$ifequal($strchr($get(path),$char(92)),1,$puts(path,_$get(path)),)$ifequal($strrchr($get(path),$char(92)),$len($get(path)),$puts(path,$get(path)$crc32(%TITLE%)),)$get(path)';
			globTags.initialArtistAlbumTrackTitlePath = '$puts(initial,$upper($cut($replace($swapprefix($if($meta_test(ALBUM ARTIST),$meta(ALBUM ARTIST,0),$meta(ARTIST,0)),A,An,The,Las,Los,Les,La,El,Le,Lo,Au,Aux,Il,I,L\'\',Gli,Una,Uno,Une,Unas,Unos,Unes,Der,Das,Die,Al,Ar,Ul,Ur,Els,Uns,Des,O,Os,As,Um,Uma,Uns,Umas),$char(33),,$char(34),,$char(35),,$char(36),,$char(37),,$char(38),,$char(39)$char(39),,$char(39),,,$char(40),,$char(41),,$char(42),,$char(43),,$char(44),,$char(45),,$char(46),,$char(47),),1)))$puts(path,$replace($if($meta_test(ALBUM ARTIST),$meta(ALBUM ARTIST,0),$meta(ARTIST,0)),$char(92),-,$char(47),-)$char(92)[$replace(%ALBUM%,$char(92),-,$char(47),-)]$char(92)[%TRACK% - ][$replace(%TITLE%,$char(92),-,$char(47),-)])$puts(path,$replace($get(path),:,, ?$char(92),,$char(63),,$char(191),,$char(8725),-,$char(36),,$char(37),,$char(35) ,,$char(35),,$char(42),,$char(33),,$char(161),,$char(124),-,$char(34),$char(39)$char(39),<,,>,,^,,... ,,...,,.,,$char(38),and))$puts(path,$replace($get(path),á,a,é,e,í,i,ó,o,ú,u,Á,A,É,E,Í,I,Ó,O,Ú,U,ü,u,Ü,U,ñ,n,Ñ,N,è,e,ê,e,Ê,E,ì,i,î,i,ï,i,à,a,â,a,ò,o,ô,o,ù,u,û,u,ç,c,Ç,C,ß,ss,œ,oe,Œ,OE))$puts(path,$replace($get(path),А,A,Б,B,В,V,Г,G,Д,D,Е,E,Ё,Jo,Ж,Zh,З,Z,И,I,Й,J,К,K,Л,L,М,M,Н,N,О,O,П,P,Р,R,С,S,Т,T,У,U,Ф,F,Х,H,Ц,C,Ч,Ch,Ш,Sh,Щ,Sht,Ъ,Y,Ь,J,Э,E,Ю,Ju,Я,Ja,а,a,б,b,в,v,г,g,д,d,е,e,ё,jo,ж,zh,з,z,и,i,й,j,к,k,л,l,м,m,н,n,о,o,п,p,р,r,с,s,т,t,у,u,ф,f,х,h,ц,c,ч,ch,ш,sh,щ,sht,ъ,y,ь,j,э,e,ю,ju,я,ja,ы,y))$puts(path,$replace($trim($replace($ascii($get(path)),$char(63),,$char(92)$char(92),$char(92)_$char(92))),$char(92) $char(92),$char(92)_$char(92),$char(92)$char(92),$char(92)_$char(92)))$ifequal($strchr($get(path),$char(92)),1,$puts(path,_$get(path)),)$ifequal($strrchr($get(path),$char(92)),$len($get(path)),$puts(path,$get(path)$crc32(%TITLE%)),)$if($stricmp($ascii($get(initial)),?),$get(initial),$ascii($get(initial)))$char(92)$get(path)';
			globTags.artistAlbumTrackIdPath = '$puts(path,$replace($if($meta_test(ALBUM ARTIST),$meta(ALBUM ARTIST,0),$meta(ARTIST,0)),$char(92),-,$char(47),-)$char(92)[$abbr($replace(%ALBUM%{$if2($replace(%COMMENT%,$char(92),,$char(8725),),%MUSICBRAINZ_ALBUMID%) },$char(92),-,$char(47),-))]$char(92)[%TRACK% - ][$abbr($replace(%TITLE%,$char(92),-,$char(47),-))])$puts(path,$replace($get(path),:,, ?$char(92),,$char(63),,$char(191),,$char(8725),-,$char(36),,$char(37),,$char(35) ,,$char(35),,$char(42),,$char(33),,$char(161),,$char(124),-,$char(34),$char(39)$char(39),<,,>,,^,,... ,,...,,.,))$puts(path,$replace($get(path),á,a,é,e,í,i,ó,o,ú,u,Á,A,É,E,Í,I,Ó,O,Ú,U,ü,u,Ü,U,ñ,n,Ñ,N,è,e,ê,e,Ê,E,ì,i,î,i,ï,i,à,a,â,a,ò,o,ô,o,ù,u,û,u,ç,c,Ç,C,ß,ss,œ,oe,Œ,OE))$puts(path,$replace($get(path),А,A,Б,B,В,V,Г,G,Д,D,Е,E,Ё,Jo,Ж,Zh,З,Z,И,I,Й,J,К,K,Л,L,М,M,Н,N,О,O,П,P,Р,R,С,S,Т,T,У,U,Ф,F,Х,H,Ц,C,Ч,Ch,Ш,Sh,Щ,Sht,Ъ,Y,Ь,J,Э,E,Ю,Ju,Я,Ja,а,a,б,b,в,v,г,g,д,d,е,e,ё,jo,ж,zh,з,z,и,i,й,j,к,k,л,l,м,m,н,n,о,o,п,p,р,r,с,s,т,t,у,u,ф,f,х,h,ц,c,ч,ch,ш,sh,щ,sht,ъ,y,ь,j,э,e,ю,ju,я,ja,ы,y))$puts(path,$lower($replace($trim($replace($ascii($get(path)),$char(63),,$char(92)$char(92),$char(92)_$char(92))),$char(92) $char(92),$char(92)_$char(92))))$ifequal($strchr($get(path),$char(92)),1,$puts(path,_$get(path)),)$ifequal($strrchr($get(path),$char(92)),$len($get(path)),$puts(path,$get(path)$crc32(%TITLE%)),)$get(path)';
