...
const callbacks = {
	...
	on_get_folder_size_done: { listeners: [], bRegistered: false, bOnVisible: false},  // JSplitter
 ...
 * : smpEvent extends ('on_get_folder_size_done')
 * 		? (taskId: number, success: boolean, size: number, error_text: string) => void
 * 		: () => void
